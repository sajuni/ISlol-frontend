<template>
  <div>
        ...
        <div class="member_info_form">
          <b-form>
            ...
            <div class="mb-4">
              ...
              <div class="error-message" v-if="validation !== undefined">
                {{ validation.firstError('newpwd2') }}
              </div>
            </div>
            <div class="mb-4">
              <b-form-input v-model="addr" type="text" placeholder="주소">
              </b-form-input>
              <div class="error-message" v-if="validation !== undefined">
                {{ validation.firstError('addr') }}
              </div>
            </div>
            <div class="mb-4">
              <b-form-input v-model="nick" type="text" placeholder="닉네임">
              </b-form-input>
              <div class="error-message" v-if="validation !== undefined">
          ...
          <div class="mt-5 mb-5">
            <b-button size="lg" variant="primary" @click="update()"
              >변경</b-button
            >
    ...
    <b-form-input v-model="seq" type="text" hidden> </b-form-input>
  </div>
</template>
